...
/** quantas linhas cabem numa tela cheia sem estourar (extra vira "+N lutas") */
const MAX_LINHAS = 10;
...
export function AreaBoard({ fila, t }: { fila: FilaDaArea; t: Txt }) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      {/* CABEÇALHO DA ÁREA */}
      <header className="flex items-end justify-between gap-4 border-b border-white/8 px-8 py-4 md:px-12 md:py-5">
      ...
      {lista.length > 0 ? (
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden px-6 py-4 md:px-12 md:py-5">
          ...
          {restantes > 0 && (
            <div className="mt-3 shrink-0 font-cond text-sm uppercase tracking-[0.06em] text-muted-3 md:text-base">
