...
export const pt = {
  ...
  criarSenha: {
    ...
    desc: "Sua inscrição já está guardada. Escolha uma senha para acessá-la quando quiser — o resto dos seus dados já ficou salvo.",
    suaConta: "Sua conta",
    senha: "Senha",
  ...
  inscricao: {
    ...
    cpfContaTitulo: "Você já tem conta",
    cpfContaDesc: "Este CPF já está cadastrado na plataforma. Entre na sua conta para se inscrever — seus dados vêm preenchidos.",
    cpfContaBotao: "Entrar",
    cpfContaFechar: "Usar outro CPF",
    ...
    cidade: "Cidade",
    uf: "UF",
    secaoPessoais: "Dados pessoais",
    secaoAtleta: "Dados do atleta",
    classeIdade: "Categoria de idade",
    categoriaPeso: "Categoria de peso",
    absolutoPergunta: "Quer lutar o absoluto?",
    absolutoNota: "O absoluto entra como segunda inscrição",
    sim: "Sim",
    nao: "Não",
    categoria: "Categoria",
    selecionada: "selecionada",
    semCategoriaCompat: "Nenhuma categoria compatível com seu perfil neste evento.",
    preenchaPre: "Preencha",
    preenchaPos: "para ver suas categorias.",
    conectorE: "e",
    emSecao: "em",
    voltar: "Voltar",
  ...
  minhas: {
    ...
    umaInscricao: "1 inscrição",
    nInscricoes: "inscrições",
  ...
  admin: {
    ...
    verDetalhes: "Ver dados do inscrito",
    contato: "Contato",
    endereco: "Endereço",
    telefone: "Telefone",
    statusLabel: "Status",
    valor: "Valor",
    inscritoEm: "Inscrito em",
    ...
    chaves: {
      ...
      loteNota: "Divisões com menos de 3 atletas usam eliminação simples.",
      publicar: "Publicar",
    ...
    areas: {
      ...
      assistenteDe: "de",
      assistenteVoltar: "Voltar",
      assistenteContinuar: "Continuar",
      assistenteAjustar: "Ajustar",
      assistenteDias: "Dias",
      assistenteTempo: "Tempo de luta",
      assistenteDistribuicao: "Categorias por dia",
      assistenteOrdem: "Ordem do dia",
      assistenteAreas: "Áreas",
      assistenteResumoDia: "dia",
      ...
      recomendacao: {
        ...
        semInscricoes:
          "Ainda não há inscrições confirmadas para estimar as lutas — a recomendação aparece assim que houver.",
        soMaisTempo:
          "Uma divisão sozinha já passa do período de um dia. Mais tatames não resolvem: amplie os horários ou adicione outro dia.",
        nemComPre: "As lutas não cabem no período nem com ",
        nemComPos: ". Amplie os horários ou adicione outro dia.",
        comecePre: "Comece com ",
        comeceFimSing: ": dá conta de todas as lutas no período.",
        comeceFimPlural: ": dão conta de todas as lutas no período.",
        faltamPre: "Com ",
        faltamMeio: " as lutas não cabem no período. Use ",
        faltamPos: " para tudo acontecer no horário.",
        sobramPre: "Você planejou ",
        sobramMeio: ", e ",
        sobramFimSing: " já daria conta — o resto é folga.",
        sobramFimPlural: " já dariam conta — o resto é folga.",
        bateFimSing: " dá conta de todas as lutas no período.",
        bateFimPlural: " dão conta de todas as lutas no período.",
      },
    },
    erros: {
      soRascunhoExcluir:
