/**
 * Configuração central de idioma (i18n) do BJJArena.
 *
 * O idioma é global: guardado num cookie (`bjjarena_lang`) para os Server
...
export const COOKIE_IDIOMA = "bjjarena_lang";
